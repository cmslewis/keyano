...
(function() {
  ...
  define(['static/js/data/KeyCodes'], function(KeyCodes) {
    var KeyMappingValidator;
    KeyMappingValidator = (function() {
      function KeyMappingValidator() {}

      KeyMappingValidator.prototype.validateKeyMapping = function(keyMapping) {
      ...
      KeyMappingValidator.prototype._validateKeyCode = function(keyCode) {
        var _ref;
      ...
      KeyMappingValidator.prototype._validatePianoKey = function(pianoKey) {
...
//# sourceMappingURL=KeyMappingValidator.js.map

...
(function() {
  ...
  define(['static/js/instrument/KeyMappingValidator', 'static/js/utils/Logger', 'static/js/config/Config', 'static/js/data/PianoKeys', 'static/js/utils/pianoKeyUtils'], function(KeyMappingValidator, Logger, Config, PianoKeys, pianoKeyUtils) {
    ...
    KeyanoInstrument = (function() {
      ...
      KeyanoInstrument.prototype._masterGainNode = null;
      ...
      function KeyanoInstrument() {
        ...
        this._resetMasterGainNode();
        this._activatePedalKey(Config.PEDAL_KEY_CODE);
        window.setVolume = _.bind(this.setVolume, this);
      }
      ...
      KeyanoInstrument.prototype._resetMasterGainNode = function() {
        this._masterGainNode = this._createVolumeNode();
        return this._masterGainNode.connect(this._audioContext.destination);
      };
      ...
      KeyanoInstrument.prototype.setVolume = function(volume) {
        if (!_.isNumber(volume) && _.isFinite(volume)) {
        ...
        return Logger.debug('@_masterGainNode.gain.value', this._masterGainNode.gain.value);
      };

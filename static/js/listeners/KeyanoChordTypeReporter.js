...
(function() {
  ...
  define(['static/js/listeners/AbstractKeyanoListener', 'static/js/data/ChordData', 'static/js/config/Config', 'static/js/utils/pianoKeyUtils'], function(AbstractKeyanoListener, ChordData, Config, pianoKeyUtils) {
    ...
    KeyanoChordTypeReporter = (function(_super) {
      ...
      KeyanoChordTypeReporter.prototype._printChord = function() {
        ...
        this.$outputElem.toggleClass('is-unknown', name === Config.LABEL_FOR_UNRECOGNIZED_CHORDS);
      };
